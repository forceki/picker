...
class _OngoingDetailState extends State<OngoingDetail> {
  ...
  _scan(barcode) async {
    var data = {'id': widget.data.id, 'barcode': barcode};

    var res = await QueueAPI().checkBarcode("picklist/detail", data);
    print(res);
    if (res['success'] == 1) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Visibility(
              visible: widget.data.status_picked ? false : true,
              child: Align(
                  alignment: Alignment.bottomCenter,
                  child: ElevatedButton(
                      child: const Text(
                        'Scan & Mark as Complete',
                        style: TextStyle(color: Colors.black),
                      ),
                      style: ElevatedButton.styleFrom(
                        shadowColor: Colors.transparent,
                        minimumSize: const Size(200, 40),
                        primary: Color.fromARGB(190, 0, 255, 110),
